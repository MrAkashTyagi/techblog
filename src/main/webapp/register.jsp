					...
					<div class="card-body">
						<form id="reg-form" action="RegisterServlet" method="post">
							<div class="form-group">
								<label for="username">User Name</label> <input name="user_name"
							...
							<div class="form-check">
								<input name="checked" type="checkbox" class="form-check-input"
							...
							<button id="submmit-btn" type="submit" class="btn btn-primary">Submit</button>
						</form>
					</div>
				</div>
			</div>
